# Generated by Django 2.0.3 on 2018-04-23 09:20
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('maximum_check_in_range', models.PositiveSmallIntegerField(help_text='오늘을 기준으로 체크인이 가능한 날 수 적어주세요', verbose_name='체크인 가능한 한계 시간')),
                ...
                ('latitude', models.DecimalField(decimal_places=14, help_text='위도를 소수점(14자리) 입력 가능 (xx.12345678901234)', max_digits=16, verbose_name='위도')),
                ('longitude', models.DecimalField(decimal_places=14, help_text='경도를 소수점(14자리) 입력 가능 (xxx.12345678901234)', max_digits=17, verbose_name='경도')),
                ('img_cover', models.ImageField(blank=True, default='', upload_to=house.models.dynamic_path.dynamic_img_cover_path)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('image', models.ImageField(help_text='숙소와 연결된 이미지를 저장합니다.', upload_to=house.models.dynamic_path.dynamic_img_house_path, verbose_name='숙소 이미지')),
                ('house', models.ForeignKey(help_text='이미지와 연결된 숙소를 저장합니다.', on_delete=django.db.models.deletion.CASCADE, related_name='images', to='house.House', verbose_name='숙소')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='house',
            name='disable_days',
            field=models.ManyToManyField(blank=True, help_text='쉬는날을 선택하세요.', related_name='houses_with_disable_day', to='house.HouseDisableDay', verbose_name='쉬는날'),
        ),
        migrations.AddField(
            model_name='house',
            name='facilities',
            field=models.ManyToManyField(blank=True, help_text='편의 시설을 선택하세요.', related_name='houses_with_facilities', to='house.Facilities', verbose_name='편의 시설'),
        ),
    ]
